        ...
        <div className={`secao ${styles.wrapper}`}>
          ...
          <div>
            <p className={styles.formacaoTexto}>
              Passei anos decifrando <span className={styles.bold}>códigos genéticos</span> agora, minha missão é
              decifrar códigos de interface e entregar{" "}
              <span className={styles.bold}>tecnologia acessível e bonita</span>.
            </p>
